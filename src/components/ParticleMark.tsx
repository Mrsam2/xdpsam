...
const IDLE_AMP              = 0
const IDLE_FREQ             = 0
const HOVER_INFLUENCE_RADIUS = 1.8
const HOVER_DISPLACEMENT    = 0
const SPRING_STIFFNESS      = 140
const SPRING_DAMPING        = 10
const HIGHLIGHT_STRENGTH    = 0.25
const LIGHT_MODE            = 2  // 0 TR, 1 TL, 2 Center, 3 None
const Z_JITTER              = 0


const PLANE_SIZE = 5.0
const TARGET_LONG_EDGE = 1600
const WORLD_LONG_EDGE = 1
...
function Scene({ src }: { src: string }) {
  ...
  return (
    <Canvas
      ...
      onCreated={({ camera, gl }) => {
        camera.lookAt(0, 0, 0)
        // Background is transparent for integration
...
export default function ParticleMark({ src = '/Saurabh Wankhede (3).png', className = '' }: { src?: string, className?: string } = {}) {
  return (
    <div
